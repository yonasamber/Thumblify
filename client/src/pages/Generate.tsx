...
const Generate = () => {
  ...
  const [thumbnail, seThumbnail] = useState<IThumbnail | null>(null);
          ...
          <div className="grid lg:grid-cols-[400px_1fr] gap-8">
            ...
            <div className={`space-y-6 ${id && "pointer-events-none"}`}>
              <div className="p-6 rounded-2xl bg-white/8 border border-white/12 shadow-xl space-y-6">
                ...
                {/*Button */}
                {!id && (
                  <button className="text-[15px] w-full py-3.5 rounded-xl font-medium bg-linear-to-b from-pink-500 to-pink-600 hover:from-pink-700 disabled:cursor-not-allowed transition-colored">
